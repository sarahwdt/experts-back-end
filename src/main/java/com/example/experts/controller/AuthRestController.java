package com.example.experts.controller;
...
/**
 * Контроллер обрабатывающий запрос для работы с личными данными текущего пользователя
 */
@RestController
...
public class AuthRestController {
     ...
     * @param json c логином и паролем
    ...
    /**
     * Обаботка запроса регистрации
     * @param json логин, пароль и подтверждение пароля
    ...
    /**
     * Запрос на смену личных данных пользователя
     * @param json логин, пароль и подтверждение пароля
     * @return результат смены данных
     */
